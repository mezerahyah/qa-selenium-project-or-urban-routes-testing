...
def get_address_to(self, address):
...
class UrbanRoutesPage:
    from_field = (By.ID, "from")  # Replace with actual ID
    to_field = (By.ID, "to")  # Replace with actual ID
    call_taxi_button = (By.XPATH, "//button[text()='Call a Taxi']")
    supportive_plan = (By.CLASS_NAME, "tcard")
...
def order_ice_creams(self, quantity=2):
    # This is where your loop from main.py should be moved
